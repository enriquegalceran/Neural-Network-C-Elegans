...
% Learning rate & increasing preiodically said value
% Also, Entropic fitting
...
%learning rate
learning_rate = 0.01;
learning_rate_frecuency = 1000;
learning_rate_rate = 0.01;
...
cada_cuantos_guardar = 100;
cada_cuantos_limpiar = 3;
...
%         res_er = Y - res; %"cuadratic"
        res_er = -Y.*log(res)+(1-Y).*log(1-res); %entropic
    ...
    i = i+1;
    elapsedTime = toc;
    if rem(i,learning_rate_frecuency) == 0 && learning_rate < learning_rate_max
