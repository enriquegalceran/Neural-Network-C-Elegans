...
% Utiliza la nueva función de entropía y semilla al azar lineal. Funciona muy bien
% con un porcentaje de acierto del 95%!!
...
for m = 1:n_iteraciones
    ...
    for n= 1:loops_cada_bloque
        ...
        if rem(i,cada_cuantos_guardar) == 0
            ...
            save(filename, 'Syn1', 'Syn2', 'Syn3', 'Syn4', 'Syn5', 'err_y', 'tarta')
            if dibujar == 2
                figure(1)
                derr_x = err_x(1:i);
                derr_y = err_y(1:i);
